...
persons_columns = c("CRSHNMBR", "CNTYCODE", "CRSHDATE", "UNITNMBR", "DRVRFLAG", "HLMTUSE", "EYEPROT", "SFTYEQP", "ROLE", "SEX", "AGE", "DISTACT", paste0("DRVRPC", formatC(seq(1, 20), width = 2, flag = "0"))) # starts_with("STATNM"), starts_with("DRVRDS"))
```
